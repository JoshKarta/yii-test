...
class NotificationController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New') . " Notification",
                ...
                return [
                    ...
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New') . " Notification",
                    'content' => '<span class="text-success">' . Yii::t('yii2-ajaxcrud', 'Create') . ' Notification ' . Yii::t('yii2-ajaxcrud', 'Success') . '</span>',
                    'footer' =>  Html::button(Yii::t('yii2-ajaxcrud', 'Close'), ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => 'modal']) .
    ...
    public function actionUpdate($id)
    {
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('yii2-ajaxcrud', 'Update') . " Notification #" . $id,
    ...
    {
        $model = NotificationUser::findOne([
            'id' => $id,
