...
/* @var $searchModel common\models\search\PostsSignatureSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Posts Signatures';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="posts-signature-index">
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['create'],
                        ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Posts Signatures', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
