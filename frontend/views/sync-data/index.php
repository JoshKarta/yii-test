...
/* @var $searchModel common\models\search\SyncDataSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Sync Datas';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="sync-data-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Sync Datas','class' => 'btn btn-outline-primary']).
