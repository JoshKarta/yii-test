...
/* @var $searchModel common\models\search\FormResponseSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Form Responses';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="form-response-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Form Responses','class' => 'btn btn-outline-primary']).
