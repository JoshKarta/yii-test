...
/* @var $searchModel common\models\search\ApiTokensSearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Api Tokens','class' => 'btn btn-outline-primary']).
