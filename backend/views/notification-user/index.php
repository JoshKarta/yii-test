...
/* @var $searchModel common\models\search\NotificationUserSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Notification Users';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="notification-user-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Notification Users','class' => 'btn btn-outline-primary']).
