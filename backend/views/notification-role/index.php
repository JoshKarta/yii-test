...
/* @var $searchModel common\models\search\NotificationRoleSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Notification Roles';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="notification-role-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Notification Roles','class' => 'btn btn-outline-primary']).
